...
def forward_flashattn(
    ...
    # Use position_ids max to determine RoPE cache length for absolute position encoding
...
# For shorter sequences or evaluation, use flash attention directly without grouping
...
# Flash attention inference version (no grouping, supports past KV)
